...
export default function StatsView({ timeline, selectedModes, isVisible }: StatsViewProps) {
  ...
  return (
    <AnimatePresence initial={false} mode="sync">
      ...
      >
      <motion.div className="stats-page-heading" initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.48, delay: 0.1, ease: statsEase }}>
        <div>
      ...
      <motion.div className="stats-kpi-grid" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.18, ease: statsEase }}>
        <motion.article className="stats-kpi" initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.42, delay: 0.22, ease: statsEase }}>
        ...
        <motion.article className="stats-kpi" initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.42, delay: 0.28, ease: statsEase }}>
        ...
        <motion.article className="stats-kpi" initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.42, delay: 0.34, ease: statsEase }}>
        ...
        <motion.article className="stats-kpi accent-kpi" initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.42, delay: 0.4, ease: statsEase }}>
      ...
      <motion.section className="stats-chart-section" aria-labelledby="activity-trend-title" initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.54, delay: 0.28, ease: statsEase }}>
        ...
        <div className="trend-chart-wrap">
          <svg className="trend-chart" viewBox="0 0 820 250" role="img" aria-labelledby="trend-chart-title trend-chart-description">
            ...
            {chartArea && <motion.polygon points={chartArea} className="trend-area" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8, delay: 0.35, ease: 'easeOut' }} />}
            {chartLine && <motion.polyline points={chartLine} className="trend-line" initial={{ pathLength: 0, opacity: 0.2 }} animate={{ pathLength: 1, opacity: 1 }} transition={{ duration: 1.1, delay: 0.35, ease: 'easeOut' }} />}
            {chart.points.map((point, index) => (
              <g key={point.bucket.key}>
                <motion.circle cx={point.x} cy={point.y} r="5" className="trend-point" initial={{ opacity: 0, scale: 0.4 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.36, delay: 0.42 + index * 0.05, ease: statsEase }} />
      ...
      <motion.div className="stats-detail-grid" initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.54, delay: 0.38, ease: statsEase }}>
      ...
      <motion.div className="stats-detail-grid country-year-grid" initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.54, delay: 0.44, ease: statsEase }}>
        <motion.section className="stats-detail-section" aria-labelledby="country-breakdown-title">
      ...
      <motion.section className="signature-section" aria-labelledby="signature-title" initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.54, delay: 0.5, ease: statsEase }}>
